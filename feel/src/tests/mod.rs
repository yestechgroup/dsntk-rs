...
static T_FUNCTION_C: LazyLock<FeelType> = LazyLock::new(|| FeelType::function(std::slice::from_ref(T_NUMBER), T_STRING));
...
static T_FUNCTION_F: LazyLock<FeelType> = LazyLock::new(|| FeelType::function(std::slice::from_ref(T_ANY), T_STRING));
static T_FUNCTION_G: LazyLock<FeelType> = LazyLock::new(|| FeelType::function(std::slice::from_ref(T_STRING), T_STRING));
